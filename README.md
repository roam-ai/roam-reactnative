...
[![npm version](https://d25lcipzij17d.cloudfront.net/badge.svg?id=js&type=6&v=0.0.14&x2=0)](https://badge.fury.io/js/roam-reactnative)
...
3. Add the dependencies below in your `app build.gradle` file. Then sync Gradle.
    ...
    ```
    dependencies {
        implementation 'com.roam.sdk:roam-android:0.0.11'
    }
    ```
